import os
os.chdir('/Users/gavin.wu/Python/Project/Marketing/FromGavin/PythonScorer')
...
full = pd.read_csv("/Users/gavin.wu/Python/Project/Marketing/merged_tu16_Apr_22_2016.csv", dtype=object)
dev = full[full["data_type"] == "dev"]
test = pd.read_csv('/Users/gavin.wu/Python/Project/Marketing/marketing_test.csv', dtype=object)
val = pd.read_csv('marketing_val_tu_ln2.csv', dtype=object)
val_schema = pd.read_csv('val_schema.txt', header=None)
val.columns=pd.Series.tolist(val_schema[0])
scorer = score()
tt = val
